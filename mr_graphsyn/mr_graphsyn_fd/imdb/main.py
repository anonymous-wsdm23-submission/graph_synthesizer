...
if __name__ == '__main__':
    ...
    for cnt in range(count):
        ...
        for i in range(epochs):
            ...
            loss, y_train, _, _ = model(node_features, A, train_node, train_target)
            ...
            with torch.no_grad():
                val_loss, y_valid, out, beta_list = model.forward(node_features, A, valid_node, valid_target)
                test_loss, y_test, _, _ = model.forward(node_features, A, test_node, test_target)
